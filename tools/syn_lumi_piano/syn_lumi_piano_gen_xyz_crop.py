...
data_dir = osp.normpath(osp.join(PROJ_ROOT, "datasets/syn_lumi_piano_dataset/data"))

cls_indexes = sorted(idx2class.keys())
cls_names = [idx2class[cls_idx] for cls_idx in cls_indexes]
lm_model_dir = osp.normpath(osp.join(PROJ_ROOT, "datasets/syn_lumi_piano_dataset/models"))
...
class XyzGen(object):
    ...
    def main(self):
        ...
        for track_idx in track_nums:
            ...
            track_root = osp.join(data_root, f"synthetic_data{track_idx}")
