...
OUTPUT_DIR = "output/gdrn/syn_lumi_piano/syn_1"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.5,
...
DATASETS = dict(
    TRAIN=("syn_lumi_piano_train",),
    TEST=("syn_lumi_piano_test",),
...
TEST = dict(EVAL_PERIOD=0, VIS=True, TEST_BBOX_TYPE="gt")  # gt | est
